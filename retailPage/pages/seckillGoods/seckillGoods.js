// pages/retailPage/seckillGoods/seckillGoods.js
const app = getApp()
...
Page({
  ...
  bindPopularChange: function (e) {
    ...
    if (idx == 0) {
      ...
      that.getInformation(uid, that.data.type, that.data.time, idx, '');
    }
  },
  seckillDetails(e){
    var sid = e.currentTarget.dataset.id;
    wx.navigateTo({
      url: '../seckillDetails/seckillDetails?sid='+sid,
    })
  },// 搜索
  search(e) {
  ...
  // 获取主页信息
  getInformation(uid, cid, field, order, keyword) {
    var that = this;
    var item = {
      merchid: uid,
      cid: cid,
