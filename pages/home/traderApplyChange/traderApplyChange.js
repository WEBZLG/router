...
Page({
  ...
  chooseImg: function (e) {
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        if (tid == 0) {
          ajax.uploadimg(tempFilePaths, function (res) {
            wx.hideLoading()
            that.setData({
  ...
  submit(){
    ...
    if (name == '' || phone == '' || idcard == '' || company == '' || address == '') {
      wx.showToast({
        title: '请填写完整数据',
        icon: "none"
      });
      ...
      (res) => {
        ...
        if (res.code == 400) {
          ...
          that.setData({
            ...
            upimages1: dataList.pic_business,
            upimages2: dataList.pic_business_charter,
            upimages3: dataList.pic_card_font,
            upimages4: dataList.pic_card_back,
            upimages5: dataList.pic_legal_card,
            isShow1: true,
            isShow2: true,
            isShow3: true,
            isShow4: true,
