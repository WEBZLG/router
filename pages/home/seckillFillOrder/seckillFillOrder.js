...
Page({
    ...
    ajax.wxRequest('POST', 'travel/seckillSignUp', item,
      (res) => {
        ...
        if (res.code == 200) {
          ...
          wx.navigateTo({
            url: '../seckillFirmOrder/seckillFirmOrder?data=' + data+'&info='+info
          });
        } else {
          wx.hideLoading();
          wx.showToast({
    ...
    ajax.wxRequest('POST', 'travel/seckillSignUp', item,
      (res) => {
        ...
        if (res.code == 200) {
          ...
          that.setData({
            updata: res.data,
            insure:res.data.in_sure,
            startTime: res.data.travelInfo.start_time,
  ...
  peopleList(uid) {
    ...
    ajax.wxRequest('POST', 'Travel/members', item,
      (res) => {
        wx.hideLoading();
        //console.log(res)
        if (res.code == 200) {
